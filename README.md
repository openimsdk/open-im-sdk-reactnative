...
OpenIM is licensed under the GNU Affero General Public License v3.0 (AGPL-3.0-only). See [LICENSE](https://github.com/openimsdk/open-im-sdk-reactnative/blob/main/LICENSE) for the full license text.
